    ...
    <html lang="en">
      ...
      >
        <header className="w-full border-b border-zinc-800 py-6 mb-2 flex flex-col items-center bg-zinc-950/80 z-10 shadow-lg">
          ...
          <span className="text-zinc-400 text-xs sm:text-sm mt-1 text-center max-w-xl px-4">
        ...
        <footer className="w-full flex flex-col items-center gap-2 py-4 border-t border-zinc-800 bg-zinc-950/80 text-zinc-400 text-xs sm:text-sm px-4 mt-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-4">
            ...
            <a href="https://x.com/artmichel_eth" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1 underline hover:text-zinc-200">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 1227" fill="currentColor" className="w-3 h-3 sm:w-4 sm:h-4"><path d="M1199.76 0H944.13L599.88 494.13 255.87 0H.24l438.6 637.5L0 1227.01h255.87l344.01-494.13 343.89 494.13h255.87L761.16 637.5z"/></svg>
